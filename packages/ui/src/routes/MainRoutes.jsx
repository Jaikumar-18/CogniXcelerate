...
const Enterprise = Loadable(lazy(() => import('@/views/solutions/Enterprise')))
const Organization = Loadable(lazy(() => import('@/views/solutions/Organization')))
const SDLC = Loadable(lazy(() => import('@/views/solutions/SDLC')))
...
const PromptManagement = Loadable(lazy(() => import('@/views/promptManagement')))
...
const MainRoutes = {
    ...
    children: [
        ...
        },
        {
            path: '/solutions',
            element: (
                <RequireAuth permission={'templates:marketplace'}>
                    <Solutions />
                </RequireAuth>
            )
        },
