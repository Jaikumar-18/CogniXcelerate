...
export const suggestionOptions = (
    ...
    items: async ({ query }) => {
        ...
        // Predefined helpful suboptions for common chat context variables
        const contextSubItems = [
            // chat_history helpers
            {
                id: 'chat_history.length',
                mentionLabel: 'chat_history.length',
                description: 'Number of messages in chat history',
                category: 'Chat Context'
            },
            {
                id: 'chat_history[0].role',
                mentionLabel: 'chat_history[0].role',
                description: 'Role of the first message (user/assistant)',
                category: 'Chat Context'
            },
            {
                id: 'chat_history[0].content',
                mentionLabel: 'chat_history[0].content',
                description: 'Content of the first message',
                category: 'Chat Context'
            },
            {
                id: 'chat_history[-1].role',
                mentionLabel: 'chat_history[-1].role',
                description: 'Role of the last message (user/assistant)',
                category: 'Chat Context'
            },
            {
                id: 'chat_history[-1].content',
                mentionLabel: 'chat_history[-1].content',
                description: 'Content of the last message',
                category: 'Chat Context'
            },
            // file_attachment helpers
            {
                id: 'file_attachment.length',
                mentionLabel: 'file_attachment.length',
                description: 'Number of attached files',
                category: 'Chat Context'
            },
            {
                id: 'file_attachment[0].name',
                mentionLabel: 'file_attachment[0].name',
                description: 'Name of the first attached file',
                category: 'Chat Context'
            },
            {
                id: 'file_attachment[0].type',
                mentionLabel: 'file_attachment[0].type',
                description: 'MIME type of the first attached file',
                category: 'Chat Context'
            },
            {
                id: 'file_attachment[0].size',
                mentionLabel: 'file_attachment[0].size',
                description: 'Size (bytes) of the first attached file',
                category: 'Chat Context'
            },
            {
                id: 'file_attachment[0].url',
                mentionLabel: 'file_attachment[0].url',
                description: 'URL to access the first attached file (if available)',
                category: 'Chat Context'
            },
            {
                id: 'file_attachment[0].text',
                mentionLabel: 'file_attachment[0].text',
                description: 'Extracted text contents of the first attached file (if available)',
                category: 'Chat Context'
            }
        ]
        ...
        // Merge all items, including suboptions
        const allItems = [
            ...defaultItems,
            ...contextSubItems,
            ...formItems,
