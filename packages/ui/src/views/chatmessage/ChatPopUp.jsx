...
import { IconMessageChatbotFilled, IconX, IconEraser, IconArrowsMaximize } from '@tabler/icons-react'
    ...
    return (
        <>
            <StyledFab
                sx={{
                    position: 'absolute',
                    right: 40, // Move a bit left from the edge
                    top: 50, // Match ActionButton's top
                    width: '48px',
                    height: '48px',
            ...
            >
                {open ? <IconX size={22} /> : <IconMessageChatbotFilled size={22} />}
            </StyledFab>
            ...
            {open && (
                <StyledFab
                    sx={{
                        position: 'absolute',
                        right: 100, // Increased from 80 to maintain spacing
                        top: 50, // Match chat icon and action button
                        width: '48px',
                        height: '48px',
            ...
            {open && (
                <StyledFab
                    sx={{
                        position: 'absolute',
                        right: 160, // Increased from 140 to maintain spacing
                        top: 50, // Match chat icon and action button
                        width: '48px',
                        height: '48px',
