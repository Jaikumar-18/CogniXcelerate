...
const StickyNote = ({ data }) => {
    ...
    // Get color from AGENTFLOW_ICONS instead of data.color
    const foundIcon = AGENTFLOW_ICONS.find((icon) => icon.name === data.name)
    const defaultColor = '#ffffff' // fallback color if data.color is not present
    const nodeColor = foundIcon?.color || data.color || defaultColor
