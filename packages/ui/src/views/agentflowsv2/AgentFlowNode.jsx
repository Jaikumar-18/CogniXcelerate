...
const AgentFlowNode = ({ data }) => {
    ...
    const defaultColor = PRIMARY_COLOR // fallback color if data.color is not present
    const nodeColor = PRIMARY_COLOR // always use primary color for all nodes
    ...
    // In getBackgroundColor, use PRIMARY_COLOR for both light and dark mode
    const getBackgroundColor = () => PRIMARY_COLOR
        ...
        <div ref={ref} onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
            ...
            <CardWrapper
                ...
                sx={{
                    ...
                    borderWidth: '2px',
                    boxShadow: data.selected ? `0 0 0 2px ${PRIMARY_COLOR} !important` : 'none',
